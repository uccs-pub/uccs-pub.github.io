---
title: "Tipuri de moțiuni și burdenul"
subtitle: "Sfaturi și exerciții"
publishDate: 2026-03-27
lead: "Acest ghid oferă o introducere clară în universul dezbaterilor academice. Spre deosebire de confruntările cotidiene, dezbaterile pun accent pe argumentarea logică și pe etica discursului, urmărind convingerea rațională, nu dominația verbală."
author: "velcea-petru"
cover: "cover.jpg"
tags:
    - dezbatere
...
```mermaid
flowchart TD
    A[Tipul moțiunii] --> B[Miza centrală]
    B --> C[Sarcina echipei]
    C --> D{{burden suficient & necesar}}
    D --> G["`Ariile de conflict
    _Unde se **câștigă** moțiunea?_`"]
    G --> J{{stabilirea ariei principale}}
    J --> K[Cazul echipei]
```
...
{{< nerdnote title="Sarcina echipei (burden)" color="info" >}}
...
{{< nerdnote title="Miza centrală" color="info" >}}
...
{{< nerdnote title="Arie de conflict" color="info" >}}
...
{{< nerdnote title="Stare de fapt (status quo)" color="info" >}}
