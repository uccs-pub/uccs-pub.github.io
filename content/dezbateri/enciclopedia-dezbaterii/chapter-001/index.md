...
{{< nerdnote title="Atenție - Ce înseamnă sumativ?" color="info" >}}
Discursul sumativ nu are voie să conțină analiză proprie sau să aducă informații noi, precum noi raționamente, exemple sau informații statistice.  Deși nu poate oferi ceva nou, este în general acceptată „reambalarea” cazului într-un mod mai oratoric/dramatic, cu rol pentru maximizarea impactului și crearea unui final organic pentru o dezbatere aprinsă.
{{< /nerdnote >}}
## Rolurile echipelor
...
{{< nerdnote title="Atenție - Număr minim de argumente" color="info" >}}
Nu există un număr minim sau maxim de argumente necesare pentru a îndeplini această sarcină, însă Guvernul trebuie să prezinte cel puțin un caz constructiv, în timp ce Opoziția poate avea unul pur distructiv.
{{< /nerdnote >}}
{{< nerdnote title="Strategie - Cazul distructiv" color="info" >}}
Cât timp Opoziția poate avea caz pur distructiv, acest lucru poate dezechilibra profund dezbaterea, iar echipa opoziantă poate fi percepută ca shallow sau ca neavând dovezi clare ori alternative mai viabile (penalizată la Strategie). Din acest motiv, este recomandat ca Opoziția să aibă și caz constructiv, centrat pe avantaje–dezavantaje și, când e nevoie, pe soluții (inclusiv pentru percepția asupra meciului și utilitatea dezbaterii).
{{< /nerdnote >}}
...
{{< nerdnote title="Are voie vorbitorul al treilea să aducă noi informații?" color="info" >}}
Ultimul vorbitor poate aduce noi informații doar daca este anunțat că vă face acest lucru de către primul vorbitor al echipei (așa cum este exemplificat în modelul opoziției).
{{< /nerdnote >}}
...
1. **Caz pur distructiv**: Atacă modelul Guvernului arătând că nu funcționează, că beneficiile sunt exagerate sau că costurile depășesc avantajele. Nu propune o alternativă proprie.
2. **Contra‑model (Counterplan)**: Propune o politică alternativă care rezolvă aceeași problemă mai bine decât modelul Guvernului. Contra‑modelul trebuie să fie mutual exclusiv (nu poți face ambele simultan) și competitiv (soluția noastră este mai bună decât a lor).
...
{{< nerdnote title="Atenție — POI-urile pot schimba rezultatul" color="info" >}}
Chiar dacă Guvernul câștigă comparativ pe conținut, stil și strategie, un meci poate fi întors de ajustările pe baza intervențiilor (POI) atunci când Guvernul nu oferă/acceptă intervenții, iar Opoziția o face consistent și/sau calitativ. Cu alte cuvinte, lipsa POI-urilor poate produce un rezultat final în care scorul total al Guvernului (după ajustări) rămâne sub cel al Opoziției, deși discursurile par „mai bune” pe grila principală.
{{< /nerdnote >}}